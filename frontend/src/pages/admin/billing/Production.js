                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {po.status === 'In Progress' && (
                              <button
                                ...
                                className="p-2 text-[#f77c1c] hover:bg-amber-50 rounded-lg transition"
          ...
          <div className="bg-white rounded-lg max-w-lg w-full">
            ...
            <form onSubmit={handleProductionSubmit} className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3 pt-4">
                <button type="submit" className="flex-1 px-4 py-2 bg-[#f77c1c] text-white rounded-lg hover:bg-amber-700 transition font-medium">
